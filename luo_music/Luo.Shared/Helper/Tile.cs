...
namespace Luo.Shared.Helper
{
    public class Tile
    {
        ...
        {
            var titlestring = ResourcesHelper.GetResString("LuooTitleString");
            string songxml = $@"
                    <tile>
                     <visual branding='nameAndLogo'>
                        <binding template='TileMedium' displayName='{titlestring}' branding='nameAndLogo' hint-textStacking='center'>
 					    ...
 					    <binding template='TileWide' displayName='{titlestring}' branding='nameAndLogo' hint-textStacking='center'>
 					        <group>
 					    ...
 					    <binding template='TileLarge' displayName='{titlestring}' branding='nameAndLogo' hint-textStacking='center'>
